...
$(DOCS_DIR)practice_final.md:$(DOCS_DIR)practice_final_with_solutions.md
	sed '/<details/,/<\/details>/d' $< > $@ 
	sed -i 's/title: Practice Final (with solutions)/title: Practice Final/g' $@
	sed -i '1s/^/<!--\n\n DO NOT EDIT THIS FILE\n\n Edit docs\/practice_final_with_solutions.md instead, and run\n \"make docs\/practice_final.md"\n instead.\n -->\n/' $@
...
#### HTML
docs-html:$(SOURCE_DOC_FILES) $(DOCS_DIR)exercises.md $(DOCS_DIR)practice_final.md
	make $(TARGET_DOC_FILES_HTML)
#### PDF
docs-pdf:$(SOURCE_DOC_FILES) $(DOCS_DIR)exercises.md $(DOCS_DIR)practice_final.md
	make $(TARGET_DOC_FILES_PDF)
#### ODT
docs-odt:$(SOURCE_DOC_FILES) $(DOCS_DIR)exercises.md $(DOCS_DIR)practice_final.md
	make $(TARGET_DOC_FILES_ODT)
#### DOCX
docs-docx:$(SOURCE_DOC_FILES) $(DOCS_DIR)exercises.md $(DOCS_DIR)practice_final.md
