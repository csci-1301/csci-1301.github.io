...
# It also copy the favicon, css and fonts files to the right place.
...
$(DOCS_DIR)practice_final.md:$(DOCS_DIR)practice_final_with_solutions.md
	sed 's/<details>/&\\\n/g' $< > $@ 
	sed '/<details>/,/<\/details>/d' $< > $@ 
	sed -i 's/ (with solutions)//g' $@
	sed -i '1s/^/<!--\n\n DO NOT EDIT THIS FILE\n\n Edit docs\/practice_final_with_solutions.md, and run\n \"make docs\/practice_final.md\"\n instead.\n -->\n/' $@

$(DOCS_DIR)mcq.md:$(DOCS_DIR)mcq_with_solutions.md
	sed 's/\[x\]/[ ]/g' $< > $@ 
	sed -i 's/ (with solutions)//g' $@
...
#### HTML
docs-html:$(SOURCE_DOC_FILES) $(DOCS_DIR)exercises.md $(DOCS_DIR)practice_final.md $(DOCS_DIR)mcq.md
	make $(TARGET_DOC_FILES_HTML)
#### PDF
docs-pdf:$(SOURCE_DOC_FILES) $(DOCS_DIR)exercises.md $(DOCS_DIR)practice_final.md $(DOCS_DIR)mcq.md
	make $(TARGET_DOC_FILES_PDF)
#### ODT
docs-odt:$(SOURCE_DOC_FILES) $(DOCS_DIR)exercises.md $(DOCS_DIR)practice_final.md $(DOCS_DIR)mcq.md
	make $(TARGET_DOC_FILES_ODT)
#### DOCX
docs-docx:$(SOURCE_DOC_FILES) $(DOCS_DIR)exercises.md $(DOCS_DIR)practice_final.md $(DOCS_DIR)mcq.md
...
### Source Code
# This code below is copied-and-pasted from https://github.com/csci-1301/C-Sharp-project-maker
