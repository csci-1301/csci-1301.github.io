...
- [Slides](https://csci-1301.github.io/slides.html) accompanying the lecture notes (in `pptx` and `pdf`).
...
Even if you do not need to understand the source code and details of the implementation of these resources (which uses, as you may have guessed … markdown!), being curious about them may be extremely useful for the sake of learning, if you want to become an [Undergraduate Course Assistant (UCA)](https://csci-1301.github.io/uca.html), are interested in contributing to open-source project, or simply wonder how the magic is done!
